...
def second_round_profiling_vert(
    ...
    for i in range(int(round_angle / rot_angle)):
        ...
        points_interp_profile, cor_faces_index = \
            compute_profiles_sampling_points(orient_points_i,
                                             vertex, max_samples,
                                             r_step, orient_face_id)
...
def vert2poly_indices(vertex_array, poly_array):
    ...
    :param vertex_array:  (n, 3) float
        Array of vertex
    :param poly_array:
        Indices of polygons of mesh.
    :return:
        Array of polygon indices related to the given vertices.
    """
